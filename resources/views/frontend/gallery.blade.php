...
.sds-bc__overlay {
    position: absolute; inset: 0;
    background: linear-gradient(150deg, rgba(15,29,58,.45) 0%, rgba(15,29,58,.18) 55%, rgba(0,0,0,.06) 100%);
}
.sds-bc__grid {
    position: absolute; inset: 0;
...
/* text legibility on bright bg */
.sds-bc__title,.sds-bc__eyebrow,.sds-bc__crumbs,.sds-bc__crumbs a,.sds-bc__crumbs span {
