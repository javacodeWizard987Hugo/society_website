                        ...
                        <div class="offcanvas__contact">
                            ...
                            <ul>
                                ...
                                <li class="d-flex align-items-center">
                                    ...
                                    <div class="offcanvas__contact-text">
                                        <a href="mailto:info@azent.com"><span class="mailto:hello@arya-labs.com">hello@arya-labs.com</span></a>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center">
                                    <div class="offcanvas__contact-icon mr-15">
        ...
        <section class="team-section-4 fix section-padding">
           <div class="container">
                ...
                <div class="text-center mb-5">
                    ...
                    <div class="single-team-items mt-0 chairman-card">
                        <div class="team-image">
                            <img src="{{ asset('build/assets/img/solomonfinal.jpeg') }}" alt="Chairman">
                            <div class="social-profile">
                                <ul>
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="http://linkedin.com/in/solomonjayasena/"><i class="fab fa-linkedin-in"></i></a></li>
                                </ul>
                                <span class="plus-btn"><i class="fas fa-share-alt"></i></span>
                            </div>
                        </div>
                        <div class="team-content text-center">
                            <h3><a href="#">Mr.Solomon Jayasena</a></h3>
                            <p>Chairman</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="single-team-items mt-0">
                                <div class="team-image">
                                   <img src="{{ asset('build/assets/img/Chamalka3.jpeg') }}" alt="team-img">
                                    <div class="social-profile">
                                        <ul>
                                              <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="#"><i class="fa-brands fa-twitter"></i></a></li>
                                            <li><a href="http://linkedin.com/in/chamalka-gimhani-852125294"><i class="fab fa-linkedin-in"></i></a></li>
                                        </ul>
                                        <span class="plus-btn"><i class="fas fa-share-alt"></i></span>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                                    <h3><a href="#">Chamalka Gimhani</a></h3>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="single-team-items mt-0">
                                <div class="team-image">
                                    <img src="{{ asset('build/assets/img/krishniga.jpeg') }}" alt="team-img">
                                    <div class="social-profile">
                                        <ul>
                                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="#"><i class="fab fa-twitter"></i></a></li>
              ...
              <div class="text-center mb-5">
                    <h2 class="section-title">Our Interns</h2>
                    <div class="team-grid-container">
                            
                          

                                <!-- Added Intern: Haseefa -->
                            <div class="single-team-items">
                                <div class="team-image" style="position: relative;">
                                    <img src="{{ asset('build/assets/img/haseefa.jpg') }}" alt="team-img">
                                    <div class="social-profile">
                                        <ul>
                                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                                            <li><a href="https://www.linkedin.com/in/fathima-haseefa-1b5332256?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"><i class="fab fa-linkedin-in"></i></a></li>
                                        </ul>
                                        <span class="plus-btn"><i class="fas fa-share-alt"></i></span>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                                    <h3><a href="#">Haseefa</a></h3>
                                    <p>Project Manager</p>
                                </div>
                            </div>
                           ...
                           <!-- <div class="single-team-items">
                                <div class="team-image" style="position: relative;">
                                    <img src="{{ asset('build/assets/img/anurda.jpg') }}" alt="team-img">
                                    <div class="social-profile">
                                        <ul>
                                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="#"><i class="fa-brands fa-twitter"></i></a></li>
                                ...
                                <div class="team-content text-center">
                                    <h3><a href="team-details.html">Anuradha</a></h3>
                                    <p>Data Scientist</p>
                                </div>
                            </div>-->
                            ...
                            <div class="single-team-items">
                                <div class="team-image" style="position: relative;">
                                    <img src="{{ asset('build/assets/img/kavinda.jpg') }}" alt="team-img">
                                    <div class="social-profile">
                                        <ul>
                                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="#"><i class="fa-brands fa-twitter"></i></a></li>
                                            <li><a href="http://www.linkedin.com/in/kavinda-ravihansa"><i class="fab fa-linkedin-in"></i></a></li>
                                        </ul>
                                        <span class="plus-btn"><i class="fas fa-share-alt"></i></span>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                                    <h3><a href="team-details.html">Kavinda Ravihansa</a></h3>
                            ...
                            <!--<div class="single-team-items">
                                <div class="team-image" style="position: relative;">
                                    <img src="{{ asset('build/assets/img/jayani.jpeg') }}" alt="team-img">
                                    <div class="social-profile">
                                        <ul>
                                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="#"><i class="fa-brands fa-twitter"></i></a></li>
                                ...
                                <div class="team-content text-center">
                                    <h3><a href="team-details.html">Jayani Malsha</a></h3>
                            ...
                            <div class="single-team-items">
                                <div class="team-image" style="position: relative;">
                                    <img src="{{ asset('build/assets/img/theeksha.jpg') }}" alt="team-img">
                                    <div class="social-profile">
                                        <ul>
                                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="#"><i class="fa-brands fa-twitter"></i></a></li>
                                            <li><a href="http://www.linkedin.com/in/theeksha-rathnayaka"><i class="fab fa-linkedin-in"></i></a></li>
                                        </ul>
                                        <span class="plus-btn"><i class="fas fa-share-alt"></i></span>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                                    <h3><a href="team-details.html">Theeksha</a></h3>
                                    <p>Full Stack Developer</p>
                                </div>
                            </div>
                            ...
                            <div class="single-team-items">
                                <div class="team-image" style="position: relative;">
                                    <img src="{{ asset('build/assets/img/sithum1.jpeg') }}" alt="team-img">
                                    <div class="social-profile">
                                        <ul>
                                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="#"><i class="fa-brands fa-twitter"></i></a></li>
                                            <li><a href="https://www.linkedin.com/in/sithum-wijesinghe-540505248/"><i class="fab fa-linkedin-in"></i></a></li>
                                        </ul>
                                        <span class="plus-btn"><i class="fas fa-share-alt"></i></span>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                                    <h3><a href="team-details.html">Sithum</a></h3>
                                    <p>Full Stack Developer</p>
                                </div>
                            </div>
                            ...
                            <div class="single-team-items">
                                <div class="team-image" style="position: relative;">
                                    <img src="{{ asset('build/assets/img/lsidu.jpg') }}" alt="team-img">
                                    <div class="social-profile">
                                        <ul>
                                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="#"><i class="fa-brands fa-twitter"></i></a></li>
                                ...
                                <div class="team-content text-center">
                                    <h3><a href="team-details.html">Lasindu</a></h3>
                                    <p>Web Developer</p>
                                </div>
                            </div>
                            ...
                            <div class="single-team-items">
                                <div class="team-image" style="position: relative;">
                                    <img src="{{ asset('build/assets/img/jarshan.jpg') }}" alt="team-img">
                                    <div class="social-profile">
                                        <ul>
                                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="#"><i class="fa-brands fa-twitter"></i></a></li>
                                            <li><a href="http://www.linkedin.com/in/mohamed-jarshan"><i class="fab fa-linkedin-in"></i></a></li>
                                        </ul>
                                        <span class="plus-btn"><i class="fas fa-share-alt"></i></span>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                                    <h3><a href="team-details.html">Jarshan</a></h3>
                                    <p>Full Stack Developer</p>
                                </div>
                            </div>
                            ...
                            <div class="single-team-items">
                                <div class="team-image" style="position: relative;">
                                    <img src="{{ asset('build/assets/img/Nipun_Anjana.jpg') }}" alt="team-img">
                                    <div class="social-profile">
                                        <ul>
                                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="#"><i class="fa-brands fa-twitter"></i></a></li>
                                            <li><a href="https://www.linkedin.com/in/nipun-rajapaksha-804305213?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"><i class="fab fa-linkedin-in"></i></a></li>
                                        </ul>
                                        <span class="plus-btn"><i class="fas fa-share-alt"></i></span>
                                    </div>
                                </div>
                                <div class="team-content text-center">
                                    <h3><a href="team-details.html">Nipun Anjana </a></h3>
                                    <p>Full Stack Developer</p>
                                </div>
                            </div>
                            <!-- Intern 9 -->
                            <div class="single-team-items">
                                <div class="team-image" style="position: relative;">
                                    <img src="{{ asset('build/assets/img/newteammember.jpeg') }}" alt="team-img">
                                    <div class="social-profile">
                                        <ul>
                                            <li><a href=""><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="#"><i class="fa-brands fa-twitter"></i></a></li>
                                ...
                                <div class="team-content text-center">
                                    <h3><a href="team-details.html">V.Akhiliny</a></h3>
